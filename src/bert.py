...
class BERT(nn.Module):
    ...
    def forward(self, features):
        ...
        # Be careful, in the evaluation_test process, the bert is not loaded
        #  from the saved bert, which was saved with cuda:2 in our disk,
        #  the bert in the evaluation_test process is still loaded from
        #  the cache ~/.cache/torch, which is a cpu saved model,
    ...
    def save(self, output_path: str):
        # logging.info('The bert accepts a save path instead '
        #              'of a save file: save to {}'.format(output_path))
