...
class DialogTransformer(nn.Sequential):
    ...
    def __init__(
        ...
        if model_name_or_path is not None and model_name_or_path != "":
            ...
            #         # print('///////////Error: import Error', file=sys.stderr)
            #         # print('=================This is the torch home', torch_cache_home, file=sys.stderr)
            # else:
...
if __name__ == '__main__':
    ...
    warmup_steps = math.ceil(
        len(train_data) * num_epochs / train_batch_size * 0.1)
    # 10% of train data for warm-up, that is, batch_count * epoch_num * 0.1
    ...
    tokenizer_name = 'bert-base-uncased'
    tokenizer_bert = BERT(tokenizer_name, devicepad='cpu')
    ...
    evaluator = DialogEvaluator(test_dataloader, name='', device='cpu')
